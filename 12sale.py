...
yrf = round(yrf,4)
print("|T恤月销售量占比：",tx*100,"%","                  |")
print("|衬衫月销售量占比：",cs*100,"%","                  |")
print("|风衣月销售量占比：",fy*100,"%","                 |")
print("|牛仔裤月销售量占比：",nzk*100,"%","               |")
print("|皮草月销售量占比：",pc*100,"%","                 |")
print("|羽绒服月销售量占比：",yrf*100,"%","               |")
print("===========================================")